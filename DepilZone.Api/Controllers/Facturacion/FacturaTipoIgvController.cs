...
namespace DepilZone.Api.Controllers.Facturacion
{
    ...
    [ApiController]
    public class FacturaTipoIgvController : ControllerBase
    {

        private readonly IFacturaTipoIgvApp _TipoIgvApp;
        public FacturaTipoIgvController(IFacturaTipoIgvApp FacturaTipoIgvApp)
        {
            _TipoIgvApp = FacturaTipoIgvApp;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> Registrar(FacturaTipoIgvDTO model)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult> Modificar(int id, FacturaTipoIgvDTO model)
        {
            try
            {
