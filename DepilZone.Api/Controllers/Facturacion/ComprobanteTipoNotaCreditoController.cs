...
namespace DepilZone.Api.Controllers.Facturacion
{
    ...
    [ApiController]
    public class ComprobanteTipoNotaCreditoController : ControllerBase
    {

        private readonly IComprobanteTipoNotaCreditoApp _TipoIgvApp;
        public ComprobanteTipoNotaCreditoController(IComprobanteTipoNotaCreditoApp ComprobanteTipoNotaCreditoApp)
        {
            _TipoIgvApp = ComprobanteTipoNotaCreditoApp;
        }
        ...
        [HttpPost]
        public async Task<ActionResult> Registrar(ComprobanteTipoNotaCreditoDTO model)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult> Modificar(int id, ComprobanteTipoNotaCreditoDTO model)
        {
            try
            {
