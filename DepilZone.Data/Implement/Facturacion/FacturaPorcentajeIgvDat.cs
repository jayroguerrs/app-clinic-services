...
{
	public class FacturaPorcentajeIgvDat : IFacturaPorcentajeIgvDat
	{
        private readonly string _connectionString;

        public FacturaPorcentajeIgvDat(string connectionString)
        {
        ...
        public async Task<List<FacturaPorcentajeIgvDTO>> Listar(int idUsuario)
        {
            try
            {
                ...
                using SqlCommand cmd = new SqlCommand("SP_FacturacionPorcentajeIgv_Listar", conn)
                {
        ...
        public async Task<List<FacturaPorcentajeIgvDTO>> Listar2(int idUsuario)
        {
            try
            {
                using SqlConnection conn = GetConnection();
                await conn.OpenAsync();
                using SqlCommand cmd = new SqlCommand("SP_FacturacionPorcentajeIgv_Listar2", conn)
                {
                    CommandType = System.Data.CommandType.StoredProcedure
                };
                cmd.Parameters.AddWithValue("pIdUsuario", idUsuario);
        ...
        public async Task<FacturaPorcentajeIgvDTO> Buscar(int id, int idUsuario)
        {
            try
            {
                using SqlConnection conn = GetConnection();
                await conn.OpenAsync();
                using SqlCommand cmd = new SqlCommand("SP_FacturacionPorcentajeIgv_BuscarPorId", conn)
                {
                    CommandType = System.Data.CommandType.StoredProcedure
                };
                cmd.Parameters.AddWithValue("pIdUsuario", idUsuario);
        ...
        public async Task<bool> Registrar(FacturaPorcentajeIgvDTO model)
        {
            try
            {
                using SqlConnection conn = GetConnection();
                await conn.OpenAsync();
                using SqlCommand cmd = new SqlCommand("SP_FacturacionPorcentajeIgv_Insertar", conn)
                {
                    CommandType = System.Data.CommandType.StoredProcedure
                };
        ...
        public async Task<bool> Modificar(int id, FacturaPorcentajeIgvDTO model)
        {
            try
            {
                using SqlConnection conn = GetConnection();
                await conn.OpenAsync();
                using SqlCommand cmd = new SqlCommand("SP_FacturacionPorcentajeIgv_Modificar", conn)
                {
                    CommandType = System.Data.CommandType.StoredProcedure
                };
                cmd.Parameters.AddWithValue("pId", id);
        ...
        static async Task<List<FacturaPorcentajeIgvDTO>> ReadListar(DbDataReader reader)
        {
            try
            {
                bool exito = true;
                ...
                List<FacturaPorcentajeIgvDTO> collection = new List<FacturaPorcentajeIgvDTO>();
                if (reader.NextResult())
                {
                    while (await reader.ReadAsync())
                    {
                        FacturaPorcentajeIgvDTO obj = new FacturaPorcentajeIgvDTO();
        ...
        static async Task<List<FacturaPorcentajeIgvDTO>> ReadListar2(DbDataReader reader)
        {
            try
            {
                bool exito = true;
        ...
        static async Task<FacturaPorcentajeIgvDTO> ReadBuscar(DbDataReader reader)
        {
            try
            {
                ...
                FacturaPorcentajeIgvDTO data = new FacturaPorcentajeIgvDTO();
                if (reader.NextResult())
                {
                    while (await reader.ReadAsync())
                    {
                        ...
                        data.Valor = Convert.ToDecimal(reader["Valor"]);
