...
{
	public class ComprobanteTipoNotaCreditoDat : IComprobanteTipoNotaCreditoDat
	{
        private readonly string _connectionString;

        public ComprobanteTipoNotaCreditoDat(string connectionString)
        {
        ...
        public async Task<List<ComprobanteTipoNotaCreditoDTO>> Listar(int idUsuario)
        {
            try
            {
                ...
                using SqlCommand cmd = new SqlCommand("SP_ComprobanteTipoNotaCredito_Listar", conn)
                {
        ...
        public async Task<List<ComprobanteTipoNotaCreditoDTO>> Listar2(int idUsuario)
        {
            try
            {
                using SqlConnection conn = GetConnection();
                await conn.OpenAsync();
                using SqlCommand cmd = new SqlCommand("SP_ComprobanteTipoNotaCredito_Listar2", conn)
                {
                    CommandType = System.Data.CommandType.StoredProcedure
                };
                cmd.Parameters.AddWithValue("pIdUsuario", idUsuario);
        ...
        public async Task<ComprobanteTipoNotaCreditoDTO> Buscar(int id, int idUsuario)
        {
            try
            {
                using SqlConnection conn = GetConnection();
                await conn.OpenAsync();
                using SqlCommand cmd = new SqlCommand("SP_ComprobanteTipoNotaCredito_BuscarPorId", conn)
                {
                    CommandType = System.Data.CommandType.StoredProcedure
                };
                cmd.Parameters.AddWithValue("pIdUsuario", idUsuario);
        ...
        public async Task<bool> Registrar(ComprobanteTipoNotaCreditoDTO model)
        {
            try
            {
                using SqlConnection conn = GetConnection();
                await conn.OpenAsync();
                using SqlCommand cmd = new SqlCommand("SP_ComprobanteTipoNotaCredito_Insertar", conn)
                {
                    CommandType = System.Data.CommandType.StoredProcedure
                };
        ...
        public async Task<bool> Modificar(int id, ComprobanteTipoNotaCreditoDTO model)
        {
            try
            {
                using SqlConnection conn = GetConnection();
                await conn.OpenAsync();
                using SqlCommand cmd = new SqlCommand("SP_ComprobanteTipoNotaCredito_Modificar", conn)
                {
                    CommandType = System.Data.CommandType.StoredProcedure
                };
                cmd.Parameters.AddWithValue("pId", id);
        ...
        static async Task<List<ComprobanteTipoNotaCreditoDTO>> ReadListar(DbDataReader reader)
        {
            try
            {
                bool exito = true;
                ...
                List<ComprobanteTipoNotaCreditoDTO> collection = new List<ComprobanteTipoNotaCreditoDTO>();
                if (reader.NextResult())
                {
                    while (await reader.ReadAsync())
                    {
                        ComprobanteTipoNotaCreditoDTO obj = new ComprobanteTipoNotaCreditoDTO();
        ...
        static async Task<List<ComprobanteTipoNotaCreditoDTO>> ReadListar2(DbDataReader reader)
        {
            try
            {
                bool exito = true;
        ...
        static async Task<ComprobanteTipoNotaCreditoDTO> ReadBuscar(DbDataReader reader)
        {
            try
            {
                ...
                ComprobanteTipoNotaCreditoDTO data = new ComprobanteTipoNotaCreditoDTO();
                if (reader.NextResult())
                {
                    while (await reader.ReadAsync())
                    {
