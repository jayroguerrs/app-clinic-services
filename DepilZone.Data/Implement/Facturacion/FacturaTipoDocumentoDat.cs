...
{
	public class FacturaTipoDocumentoDat : IFacturaTipoDocumentoDat
	{
        private readonly string _connectionString;

        public FacturaTipoDocumentoDat(string connectionString)
        {
        ...
        public async Task<List<FacturaTipoDocumentoDTO>> Listar(int idUsuario)
        {
            try
            {
                ...
                using SqlCommand cmd = new SqlCommand("SP_FacturacionTipoDocumento_Listar", conn)
                {
        ...
        public async Task<List<FacturaTipoDocumentoDTO>> Listar2(int idUsuario)
        {
            try
            {
                using SqlConnection conn = GetConnection();
                await conn.OpenAsync();
                using SqlCommand cmd = new SqlCommand("SP_FacturacionTipoDocumento_Listar2", conn)
                {
                    CommandType = System.Data.CommandType.StoredProcedure
                };
                cmd.Parameters.AddWithValue("pIdUsuario", idUsuario);
        ...
        public async Task<FacturaTipoDocumentoDTO> Buscar(int id, int idUsuario)
        {
            try
            {
                using SqlConnection conn = GetConnection();
                await conn.OpenAsync();
                using SqlCommand cmd = new SqlCommand("SP_FacturacionTipoDocumento_BuscarPorId", conn)
                {
                    CommandType = System.Data.CommandType.StoredProcedure
                };
                cmd.Parameters.AddWithValue("pIdUsuario", idUsuario);
        ...
        public async Task<bool> Registrar(FacturaTipoDocumentoDTO model)
        {
            try
            {
                using SqlConnection conn = GetConnection();
                await conn.OpenAsync();
                using SqlCommand cmd = new SqlCommand("SP_FacturacionTipoDocumento_Insertar", conn)
                {
                    CommandType = System.Data.CommandType.StoredProcedure
                };
                ...
                cmd.Parameters.AddWithValue("pLongitud", model.Longitud);
        ...
        public async Task<bool> Modificar(int id, FacturaTipoDocumentoDTO model)
        {
            try
            {
                using SqlConnection conn = GetConnection();
                await conn.OpenAsync();
                using SqlCommand cmd = new SqlCommand("SP_FacturacionTipoDocumento_Modificar", conn)
                {
                    CommandType = System.Data.CommandType.StoredProcedure
                };
                cmd.Parameters.AddWithValue("pId", id);
        ...
        static async Task<List<FacturaTipoDocumentoDTO>> ReadListar(DbDataReader reader)
        {
            try
            {
                bool exito = true;
                ...
                List<FacturaTipoDocumentoDTO> collection = new List<FacturaTipoDocumentoDTO>();
                if (reader.NextResult())
                {
                    while (await reader.ReadAsync())
                    {
                        FacturaTipoDocumentoDTO obj = new FacturaTipoDocumentoDTO();
                        ...
                        obj.Longitud = Convert.ToInt32(reader["Longitud"]);
        ...
        static async Task<List<FacturaTipoDocumentoDTO>> ReadListar2(DbDataReader reader)
        {
            try
            {
                bool exito = true;
        ...
        static async Task<FacturaTipoDocumentoDTO> ReadBuscar(DbDataReader reader)
        {
            try
            {
                ...
                FacturaTipoDocumentoDTO data = new FacturaTipoDocumentoDTO();
                if (reader.NextResult())
                {
                    while (await reader.ReadAsync())
                    {
                        ...
                        data.Longitud = Convert.ToInt32(reader["Longitud"]);
